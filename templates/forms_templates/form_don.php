        ...
        <!-- Le slide du don-->
            <div class="title_phase" id="don_phaseone">
                <p>1. <?php _e("Montant du don","ws"); ?> </p>
            </div>
            <div id="donbox">
              <div id="setMoney">
                ...
                <p><?php _e("Amount after deduction","ws"); ?> : <strong id="firstDeductionIndicator">x,xx</strong> &#8364;</p>
                <p><input type="button" onClick="donPage.MoneyInfo();" class="don_continuer" value="<?php _e('Continuer',"ws"); ?>" /></p>
              </div>
              <div id="moneyInfo" >
                <input type="hidden" id="don_deduction" value="0"/>
                <p id="modify"><a href="javascript:donPage.SetMoney();"><?php _e("Modifier","ws"); ?></a></p>
                <p><strong id="moneyIndicator">50</strong><strong>&#8364;</strong>-<?php _e("Montant après déduction","ws"); ?> <strong id="secondDeductionIndicator">17</strong><strong>&#8364;</strong></p>
              </div>
            </div>
            <div class="cb"></div>
            <br/>
              ...
              <?php foreach ($additionalsinputs_data as $groupe) : ?>
                ...
                <?php endforeach; ?>
                  <div class="submit_box">
                   <input type="submit" class="don_continuer" value="<?php _e('Continuer',"ws"); ?>" />
                  </div>
                </div>
            </div>
